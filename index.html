...
<head>
  <meta charset="UTF-8">
    ...
    <title>FREE | CF | LIFETIME |USER-CEPU-US-KG</title>
    <meta name="description" content="FREE | CF | LIFETIME |USER-CEPU-US-KG">
    <meta name="keywords" content="FREE | CF | LIFETIME |USER-CEPU-US-KG">
    <meta name="author" content="FREE | CF | LIFETIME |USER-CEPU-US-KG">
    <meta name="robots" content="FREE | CF | LIFETIME |USER-CEPU-US-KG">

    <!-- Open Graph Meta Tags untuk SEO Media Sosial -->
    <meta property="og:title" content="FREE | CF | LIFETIME |USER-CEPU-US-KG">
    <meta property="og:description" content="FREE | CF | LIFETIME |USER-CEPU-US-KG">
    ...
    <meta name="twitter:title" content="FREE | CF | LIFETIME |USER-CEPU-US-KG">
    <meta name="twitter:description" content="FREE | CF | LIFETIME |USER-CEPU-US-KG">
...
#link1 {
      ...
      padding: 10px; /* Menambahkan padding agar teks tidak menempel */
      border: 1px solid #ccc; /* Memberikan border agar lebih terlihat */
      font-size: 14px; /* Ukuran font agar teks mudah dibaca */
      color: #333; /* Warna teks */
      background-color: #fff; /* Latar belakang putih */
      word-wrap: break-word; /* Membungkus teks panjang */
      text-align: left; /* Rata kiri untuk teks */
      white-space: normal; /* Membuat teks panjang bisa terbungkus */
    }
...
.flag-icon {
   ...
   .service-selector, .link1, .link2 {
    ...
    .service-selector:hover, .link1:hover, .link2:hover {
...
.button {
  ...
  margin-right: 20px;
    ...
    .column-1 {
      width: 100px; /* Kolom pertama 30% dari tabel */
    }
    .column-2 {
      width: 50%; /* Kolom kedua 50% dari tabel */
    }
    .column-3 {
      width: 20%; /* Kolom ketiga 20% dari tabel */
    }
  ...
  pointer-events: auto; /* Aktifkan interaksi pointer */
    ...
    /* Button Colors */
    .button { 
      background-color: rgba(64, 4, 183, 0.97); 
      color: white; 
  ...
  pointer-events: auto; /* Aktifkan interaksi pointer */
    ...
    .copy-ss {      
      margin: 5px;
      background-color: #D35400; /* Orange Gelap */
      color: white;
      border: none;
      padding: 10px 20px;
      font-size: 16px;
  ...
  pointer-events: auto; /* Aktifkan interaksi pointer */
    ...
    .copy-vless:active,
    .copy-vless877:active,
    .copy-vless1:active, 
    .copy-vless1877:active, 
    .copy-trojan:active, 
    .copy-trojan877:active, 
    .copy-ss:active {
      background-color: #E67E22; /* Warna berubah saat diklik */
    ...
    .copy-vless2877, 
    .copy-trojan-clash, 
    .copy-trojan-clash877, 
    .copy-ss1 {
      margin: 5px;
      background-color: #196F3D; /* Hijau Gelap */
      color: white;
      border: none;
      padding: 10px 20px;
      font-size: 16px;
  ...
  pointer-events: auto; /* Aktifkan interaksi pointer */
    ...
    .copy-vless-clash:active,
    .copy-vless-clash877:active,
    .copy-vless2:active, 
    .copy-vless2877:active, 
    .copy-trojan-clash:active, 
    .copy-trojan-clash877:active, 
    .copy-ss1:active {
      background-color: #27AE60; /* Warna berubah saat diklik */
      box-shadow: 0 2px 3px rgba(0, 0, 0, 0.2);
      transform: scale(0.98);
    }  
    /* Styling for the cekproxy button */
    .cekproxy {
      padding: 10px 20px;
      background-color: rgba(151, 180, 1, 1); /* Warna dasar biru */
      color: white; /* Warna teks */
      border: 1px solid rgba(197, 51, 6, 0.89); /* Border biru tua */
    ...
    .cekproxy:hover {
      ...
      box-shadow: 0 8px 12px rgba(0, 0, 0, 0.3), 0 0 10px rgba(52, 152, 219, 0.5); /* Tambahan glow biru */
    }

    /* Active (click) effect */
    .cekproxy:active {
      transform: scale(0.95); /* Sedikit mengecil saat diklik */
      border-color: #1c5980; /* Border menjadi lebih gelap */
      box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3); /* Shadow lebih redup */
    }
...
#copyLink1:active {
  background-color: #1c5985; /* Warna lebih gelap saat tombol ditekan */
}
...
<body>
  <header>
  <h1>FREE CF USER-CEPU-US-KG</h1>
    </header>
  <main class="content">
    <center><button class="button7" onclick="showPopup('sub-link')">SHOW LINK SUB</button></center>
<div class="filters">
      <div><span class="filter-label">Items page:</span>
<select class="service-selector" id="items-per-page">
...
<input type="text" id="search-bar" placeholder="Search by IP, Port, ID, ISP" />
</div>
</div>
...
<div class="popup" id="sub-link">
<div class="popup-content">
  <div class="table-container">
<table>
  <span>SUB LINK GERETATED</span>
  <thead><tr>
       <th></th>
          <th></th>
      <th></th>
          ...
          <tbody><tr><td>
          ...
          </td><td><select class="service-selector" id="app" class="form-control" required>
            ...
            <td><button class="button7" onclick="hidePopup('sub-link')">Close</button>
    </td></tr>

            <tr><td><label for="bug">BUG/WILDCARD:</label>
                </td><td><select class="service-selector" id="bug">
                  ...
                  <select class="service-selector" id="wildcard" class="form-control">
            ...
            <tr><td>
<label for="configType">TIPE CONFIG-TLS/NTLS:</label>
               </td><td> <select class="service-selector" id="configType" class="form-control" required>
                    <option value="vless">VLESS</option>
                    <option value="trojan">TROJAN</option>
                    <option value="shadowsocks">SHADOWSOCKS</option>
                </select></td><td>
                 <select class="service-selector" id="tls">
    ...
    <tr>
                ...
                <td><label for="country">NEGARA/LIMIT:</label>
                </td><td><select class="service-selector" id="country" class="form-control">
    ...
    <option value="ZW">Zimbabwe</option>
                  ...
                  <input class="service-selector" type="number" id="limit" class="form-control" value="10" />

        </td></tr>
<tr><td>
            
                <label for="link1">GENERATED LINK:</label><br>
               </td><td> <input class="service-selector" type="text" id="link1" readonly /><br><br/>
                </td><td><button id="copyLink1" onclick="copyLink(this)">COPY LINK</button>
        </td></tr>
</tbody></table>
    </div>
    </div>
  ...
  <footer class="footer">
    <h2><p>&copy; 2024 FREE PROXY CF USER-CEPU-US-KG</p></h2>
  </footer>
<script>
...
function generateLinks() {
  ...
  var link1 = `https://user.cepu.us.kg/vpn/${app}?type=${configType}&bug=${bug}&tls=${tls}&wildcard=${wildcard}&limit=${limit}&country=${country}`;

  // Tampilkan link pada input box
  document.getElementById("link1").value = link1;

  // Update data-link pada tombol salin
...
// Tambahkan event listener untuk elemen input
document.addEventListener("DOMContentLoaded", function () {
  var inputs = document.querySelectorAll("#app, #configType, #bug, #tls, #wildcard, #limit, #country");
  inputs.forEach(function (input) {
    input.addEventListener("change", generateLinks);
  });
...
function uuidv4() {
  ...
  fetch("https://ndeso.web.id/bot/proxy_list.txt")
    ...
    totalProxyElement.innerHTML = `<strong>Total Proxies:</strong> ${allProxies.length}`;

    // Fungsi untuk memperbarui jumlah proxy yang difilter
    const updateFilteredProxies = () => {
      filteredProxyElement.innerHTML = `<strong>Filtered Proxies:</strong> ${filteredProxies.length}`;
    };
      ...
      searchInput.addEventListener('input', () => {
        ...
        filteredProxies = allProxies.filter(proxy => {
          ...
          return ip.toLowerCase().includes(query) || port.includes(query) || id.toLowerCase().includes(query) || isp.toLowerCase().includes(query);
        });
        renderProxies(filteredProxies, proxyList, pagination, itemsPerPage);
      });
  ...
  function checkProxyStatus(ip, port, statusElement) {
    ...
    const Status = `https://ipcf.vlessipcf.us.kg/key=geo/ip=${ip}:${port}`;
    
    fetch(Status)
      .then(response => response.json())
      .then(data => {
        const endTime = performance.now();
        const latency = (endTime - startTime).toFixed(2); // Menghitung latency

        // Menampilkan status proxy dan latency
        if (data.proxyStatus === "ACTIVE") {
          statusElement.innerHTML = `
          <span class="check-icon">&#10004;</span> (${latency} ms)
        `;
          statusElement.style.color = 'green';
          } else if (data.proxyStatus === "DEAD") {
          statusElement.innerHTML = `
          <span class="error-icon">&#10006;</span> Dead
        `;
  ...
  function renderProxies(proxies, proxyList, pagination, itemsPerPage) {
    ...
    function updatePage(page) {
      ...
      pageProxies.forEach(proxy => {
        ...
        row.innerHTML = `
          <td>
            <span>${isp} | ${id}</span>
            <span class="flag-icon flag-icon-${id.toLowerCase()}"></span> <!-- Display the flag -->
            </td>
          <td>
            <span id="status-${ip}-${port}">Loading...</span>
          </td>
          ...
          <td><button class="button" onclick="showPopup('vtls${ip}:${port}')">VLESS TLS 443</button>
      ...
      » IP:PORT      : ${ip}:${port}<br>
      <hr/>VLESS<br>
      <button class="copy-vless">COPY VLESS 443</button>
      <br><button class="copy-vless-clash">COPY CLASH 443</button>
      <hr/>
      <button class="button8" onclick="hidePopup('vtls${ip}:${port}')">Close</button> 
</div>
</div></td>
          <td><button class="button" onclick="showPopup('trojan${ip}:${port}')">TROJAN TLS 443</button>
      ...
      » IP:PORT      : ${ip}:${port}<br>
      <hr/>TROJAN<br>
      <button class="copy-trojan">COPY TROJAN 443</button>
      <br><button class="copy-trojan-clash877">COPY CLASH 443</button> 
      <hr/>
      <button class="button8" onclick="hidePopup('trojan${ip}:${port}')">Close</button> 
    </div>
    </div></td>
          <td><button class="button" onclick="showPopup('ss${ip}:${port}')">SHADOWSOCK</button>
      ...
      » IP:PORT      : ${ip}:${port}<br>
      <hr/>SHADOWSOCK<br>
      <button class="copy-ss">COPY SHADOWSOCK</button>
      <br><button class="copy-ss1">COPY CLASH</button>
     <hr/> <button class="button8" onclick="hidePopup('ss${ip}:${port}')">Close</button> 
    </div>
    </div></td>
        `;
    ...
    const selectedService = row.querySelector('.service-selector').value || "user.cepu.us.kg";
    const domain = selectedService === "user.cepu.us.kg" ? "user.cepu.us.kg" : `${selectedService}.user.cepu.us.kg`;
    const VLESS = `vless://${uuidv4()}@${selectedService}:443?encryption=none&type=ws&host=${domain}&path=%2F${ip}-${port}&security=tls&sni=${domain}#(${selectedService})+${id}+${isp}`;
...
row.querySelector('.copy-vless-clash').addEventListener('click', () => {
    const selectedService = row.querySelector('.service-selector').value || "user.cepu.us.kg";
    const domain = selectedService === "user.cepu.us.kg" ? "user.cepu.us.kg" : `${selectedService}.user.cepu.us.kg`;
    const VLESSC = `- name: (${selectedService})+${id}+${isp}
...
row.querySelector('.copy-trojan').addEventListener('click', () => {
    const selectedService = row.querySelector('.service-selector').value || "user.cepu.us.kg";
    const domain = selectedService === "user.cepu.us.kg" ? "user.cepu.us.kg" : `${selectedService}.user.cepu.us.kg`;
    const TROJAN = `trojan://${uuidv4()}@${selectedService}:443?encryption=none&type=ws&host=${domain}&path=%2F${ip}-${port}&security=tls&sni=${domain}#(${selectedService})+${id}+${isp}`;
...
row.querySelector('.copy-trojan-clash877').addEventListener('click', () => {
    ...
    const domain = selectedService === "xvp.bmkg.xyz" ? "xvp.bmkg.xyz" : `${selectedService}.xvp.bmkg.xyz`;
    const TROJANC877 = `- name: (${selectedService})+${id}+${isp}
    server: ${selectedService}
    port: 443
    type: trojan
    password: ${uuidv4()}
...
row.querySelector('.copy-ss').addEventListener('click', () => {
    const selectedService = row.querySelector('.service-selector').value || "user.cepu.us.kg";
    const domain = selectedService === "user.cepu.us.kg" ? "user.cepu.us.kg" : `${selectedService}.user.cepu.us.kg`;
    const SS = `ss://bm9uZTo1ZDJlYmQyYS05Y2I5LTRkMWItYWY1NS04NjE3ZDNlODFmMzk%3D@${selectedService}:443?encryption=none&type=ws&host=${domain}&path=%2F${ip}-${port}&security=tls&sni=${domain}#(${selectedService})+${id}+${isp}`;
